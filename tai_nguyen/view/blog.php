            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <div class="blog-item">
                  ...
                  <div class="blog-detail"> <span class="post-date">02 jan 2017</span>
                    <h3><a href="single-blog.html">Combined with a handful of model</a></h3>
                    <p>Uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures donec sollicitudin erat eget malesuada scelerisque. Nullam consectetur, arcu sed tincidunt mattis, massa nunc sodales mauris, ut lobortis arcu tortor in risus.</p>
                    <hr>
                    <div class="post-info">
              ...
              <div class="col-xs-12">
                <div class="blog-item">
                  ...
                  <div class="blog-detail"> <span class="post-date">03 jan 2017</span>
                    <h3><a href="single-blog.html">Combined with a handful of model</a></h3>
                    <p>Uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures donec sollicitudin erat eget malesuada scelerisque. Nullam consectetur, arcu sed tincidunt mattis, massa nunc sodales mauris, ut lobortis arcu tortor in risus.</p>
                    <hr>
                    <div class="post-info">
                ...
                <ul>
                  <li>
                    ...
                    <div class="pro-detail-info"> <a>Black African Print</a>
                      <div class="post-info">Fab 11, 2016</div>
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="images/blog_img4.jpg"></a> </div>
                    <div class="pro-detail-info"> <a>Black African Print</a>
                      <div class="post-info">Fab 11, 2016</div>
                    </div>
                  </li>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="images/blog_img5.jpg"></a> </div>
                    <div class="pro-detail-info"> <a>Black African Print</a>
                      <div class="post-info">Fab 11, 2016</div>
                    </div>
                  </li>
